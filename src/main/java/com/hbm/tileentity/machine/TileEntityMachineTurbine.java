...
public class TileEntityMachineTurbine extends TileEntityLoadedBase implements ISidedInventory, IFluidContainer, IEnergyProviderMK2, IFluidStandardTransceiver, IGUIProvider, SimpleComponent, ManagedPeripheral, IInfoProviderEC {
	...
	public String getComponentName() {
		return CompatHandler.Compats.SMALL_TURBINE.name;
	}
