...
public class TileEntityMachineTurbineGas extends TileEntityMachineBase implements IFluidStandardTransceiver, IEnergyProviderMK2, IControlReceiver, IGUIProvider, SimpleComponent, ManagedPeripheral, IInfoProviderEC {
	...
	public String getComponentName() {
		return CompatHandler.Compats.GAS_TURBINE.name;
	}
