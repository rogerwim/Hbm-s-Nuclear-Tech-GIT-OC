...
public class TileEntityMachineBattery extends TileEntityMachineBase implements IEnergyConductorMK2, IEnergyProviderMK2, IEnergyReceiverMK2, IPersistentNBT, SimpleComponent, ManagedPeripheral, IGUIProvider, IInfoProviderEC {
	...
	public String getComponentName() {
		return CompatHandler.Compats.BATTERY.name;
	}
	...
	public Object[] invoke(String method, Context context, Arguments args) throws Exception {
		switch(method) {
			case ("getEnergyInfo"): //stupid, but for compatibility reasons
			case ("getInfo"):
